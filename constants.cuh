...
// Steps
inline constexpr int NSTEP = 100;
inline constexpr int NOUTPUT = 1;
...
// Jet parameters
inline constexpr real_t jet_radius = 6.0;
inline constexpr real_t jet_x0 = NX / 2.0;
inline constexpr real_t jet_z0 = NZ / 2.0;
inline constexpr real_t jet_velocity = 0.0665;

// Bubble parameters
inline constexpr real_t bubble_radius = 8.0;
...
inline constexpr real_t Re = static_cast<real_t>(500);
inline constexpr real_t nu = static_cast<real_t>(2 * jet_radius * jet_velocity) / Re;

inline constexpr real_t taur = static_cast<real_t>(0.6); // static_cast<real_t>(0.5) + nu / (cs2); static_cast<real_t>(0.6)

inline constexpr real_t taub = static_cast<real_t>(0.6);

inline constexpr real_t omegar = static_cast<real_t>(1) / taur;
inline constexpr real_t omegab = static_cast<real_t>(1) / taub;

inline constexpr real_t sigma = static_cast<real_t>(0.040);
inline constexpr real_t beta_recolor = real_t(0.85); // typical 0.6–0.9
