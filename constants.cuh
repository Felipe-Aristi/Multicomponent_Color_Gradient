...
inline constexpr real_t cs2 = static_cast<real_t>(static_cast<double>(1.0) / static_cast<double>(3.0));
...
inline constexpr real_t sigma = static_cast<real_t>(0.00000000000000010);
